...
const SingleCard = async ({
  ...
  return (
    <div className="border w-auto rounded-md border-green-800 px-3">
      <div className="shadow-xl rounded-md">
        ...
        <div className="p-4">
          ...
          <Link
            href={`${link}`}
            className="text-base text-orange-700 hover:text-blue-800 break-words underline"
          >
            {link}
          </Link>
          <div className="mt-4 flex justify-end">
            <div className="rounded-md px-4 py-2 text-sm text-orange-600 flex items-center gap-2">
              <span>Tags:</span>{" "}
              <ChevronRightIcon className="w-5 h-5 uppercase" /> {tag}
            </div>
          </div>
        </div>
      </div>
